...
const ruleData: Rule[] = [
  {
    ...
    desc: [
      ...
      "Example: You want to calm down an angry innkeeper. This requires a 🗣️ CHARISMA roll at Difficulty 10.",
      "If you have a 🗣️ CHARISMA score of 6, you need to roll 5 or more on 2d6 to succeed.",
    ...
    tables: [
      {
        ...
        rows: [
          ["🗣️", "CHARISMA", "The knack of befriending people"],
